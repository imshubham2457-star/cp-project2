...
const LOCAL_STORE_KEYS = {
  ...
  orders: "cara_orders",
  dataVersion: "cara_data_version",
};

const DEFAULT_PRODUCTS = [
  { id: 1, name: "Apple iPhone 15 (Blue, 128 GB)", brand: "Apple", price: 79900, image: "https://images.unsplash.com/photo-1695048133142-1a20484d2569?auto=format&fit=crop&w=900&q=80", stock: 25, description: "6.1-inch Super Retina XDR, A16 Bionic, dual camera, USB-C.", category: "Mobiles" },
  { id: 2, name: "boAt Rockerz 450 Bluetooth On-Ear Headphones", brand: "boAt", price: 1499, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=900&q=80", stock: 200, description: "40mm drivers, up to 15 hours playback, lightweight foldable design.", category: "Electronics" },
  { id: 3, name: "Tata Tea Gold, 500g", brand: "Tata", price: 285, image: "https://images.unsplash.com/photo-1558160074-4d7d8bdf4256?auto=format&fit=crop&w=900&q=80", stock: 500, description: "Premium blend with long leaves for a strong, refreshing cup.", category: "Grocery" },
  { id: 4, name: "Samsung Galaxy M34 5G (8GB RAM, 128GB)", brand: "Samsung", price: 18999, image: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?auto=format&fit=crop&w=900&q=80", stock: 60, description: "120Hz AMOLED, 6000mAh battery, 50MP triple camera.", category: "Mobiles" },
  { id: 5, name: "Prestige Popular Svachh Aluminium Pressure Cooker 5 L", brand: "Prestige", price: 2495, image: "https://images.unsplash.com/photo-1584990347449-ae93369c6484?auto=format&fit=crop&w=900&q=80", stock: 80, description: "Gas and induction compatible, deep lid controls spillage.", category: "Home & Kitchen" },
  { id: 6, name: "Lux Velvet Touch Soap Pack of 3", brand: "Lux", price: 235, image: "https://images.unsplash.com/photo-1607602132700-0682582d9789?auto=format&fit=crop&w=900&q=80", stock: 300, description: "Fragrant bathing bars with moisturizing benefits.", category: "Beauty" },
  { id: 7, name: "Philips Air Fryer HD9252/90 (4.1 L)", brand: "Philips", price: 8999, image: "https://images.unsplash.com/photo-1585238342024-78d387f4a707?auto=format&fit=crop&w=900&q=80", stock: 40, description: "Rapid Air technology, digital display, preset recipes.", category: "Home & Kitchen" },
  { id: 8, name: "MI Power Bank 3i 20000mAh (18W Fast Charging)", brand: "Mi", price: 2199, image: "https://images.unsplash.com/photo-1583863788434-e58a36330cf0?auto=format&fit=crop&w=900&q=80", stock: 150, description: "Dual USB output, Type-C, BIS certified.", category: "Electronics" },
  { id: 9, name: "Puma Unisex Softride Running Shoes", brand: "Puma", price: 3499, image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=900&q=80", stock: 90, description: "Cushioned midsole, breathable mesh upper.", category: "Fashion" },
  { id: 10, name: "Dettol Antiseptic Liquid 1 L", brand: "Dettol", price: 289, image: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=900&q=80", stock: 400, description: "First-aid, surface cleaning, and personal hygiene.", category: "Health" },
];
...
function ensureLocalSeed() {
  const version = readLocal(LOCAL_STORE_KEYS.dataVersion, null);
  if (!readLocal(LOCAL_STORE_KEYS.products, null) || version !== LOCAL_DATA_VERSION) {
    writeLocal(LOCAL_STORE_KEYS.products, DEFAULT_PRODUCTS);
    writeLocal(LOCAL_STORE_KEYS.dataVersion, LOCAL_DATA_VERSION);
  }
...
function resolveImageSrc(image) {
  ...
  return /^https?:\/\//i.test(img) ? img : `./${img}`;
}
  ...
  cartBody.innerHTML = items
    .map(
      (item) => `<tr data-cart-id="${item.id}">
        ...
        <td><img src="${resolveImageSrc(item.image)}" alt="${item.name}"></td>
        <td>${item.name}</td>
